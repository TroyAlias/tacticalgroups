...
namespace TacticalGroups
{
	...
	public static class Strings
	{
		...
		public static readonly string ColonistBarSpacingX = "TG.ColonistBarSpacingX".Translate();
		public static readonly string ColonistBarSpacingY = "TG.ColonistBarSpacingY".Translate();
		...
		public static readonly string GroupApparelPolicyTooltip = "TG.GroupApparelPolicyTooltip".Translate();
		...
		public static readonly string PresetApparelPolicyPolicyTooltip = "TG.PresetApparelPolicyPolicyTooltip".Translate();
