...
namespace TacticalGroups
{
    ...
    public static class HarmonyPatches
    {
        static HarmonyPatches()
        {
            ...
            harmony.Patch(AccessTools.Method(typeof(CaravanExitMapUtility), 
                nameof(CaravanExitMapUtility.ExitMapAndCreateCaravan), parameters: new Type[]
            {
                typeof(IEnumerable<Pawn>),
                typeof(Faction),
                typeof(PlanetTile),
                typeof(Direction8Way),
                typeof(PlanetTile),
                typeof(bool)
        ...
        private static void ExitMapAndCreateCaravan(Caravan __result)
        {
        ...
        private static void CaravanEnter(Caravan caravan, Map map)
        {
            TacticUtils.TacticalGroups.RemoveCaravanGroup(caravan);
