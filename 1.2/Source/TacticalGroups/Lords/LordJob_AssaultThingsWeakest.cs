...
{
	public class LordJob_AssaultThingsWeakest : LordJob
	{
		...
		public LordJob_AssaultThingsWeakest()
		{
		}

		public LordJob_AssaultThingsWeakest(Faction assaulterFaction, List<Thing> things, float damageFraction = 1f, bool useAvoidGridSmart = false)
		{
		...
		public override StateGraph CreateGraph()
		{
			...
			LordToil lordToil = new LordToil_AssaultThingsWeakest(things);
