...
namespace TacticalGroups
{
	public class Dialog_NewPresetName : Dialog_Rename
	{
		...
		public Dialog_NewPresetName(TieredFloatMenu parentWindow, GroupPreset groupPreset, ColonistGroup colonistGroup, Rect originRect, Texture2D backgroundTexture)
