...
namespace TacticalGroups
{
    ...
    public static class TexturesUtils
    {
        ...
        {
            Texture2D readableBackground = GetReadableTexture(background);
            Texture2D readableOverlay = GetReadableTexture(overlay);
        ...
        {
            Texture2D copy = new Texture2D(origin.width, origin.height);
            Color[] pixels = origin.GetPixels();
            Color[] darkenColors = new Color[pixels.Length];
