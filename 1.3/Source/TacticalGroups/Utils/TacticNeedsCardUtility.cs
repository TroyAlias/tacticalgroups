...
{
    public static class TacticNeedsCardUtility
    {
        ...
        public static Vector2 GetSize(Pawn pawn)
        {
            ...
            return new Vector2(225f, displayNeeds.Count * Mathf.Min(70f, FullSize.y / displayNeeds.Count));
        }
        ...
        public static void DoNeeds(Rect rect, Pawn pawn)
        {
            ...
            for (int i = 0; i < displayNeeds.Count; i++)
            {
                ...
                Rect rect2 = new Rect(rect.x, rect.y + num, rect.width, height);
        ...
        private static void DrawThoughtListing(Rect listingRect, Pawn pawn, ref Vector2 thoughtScrollPosition)
        {
            ...
            float height = thoughtGroupsPresent.Count * 24f;
