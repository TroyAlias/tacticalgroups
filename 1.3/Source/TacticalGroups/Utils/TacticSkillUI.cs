...
namespace TacticalGroups
{
	...
	public static class TacticSkillUI
	{
		...
		{
			DrawSkill(skill, new Rect(topLeft.x, topLeft.y, 165f, 19f), mode);
		}
		...
		public static void DrawSkill(SkillRecord skill, Rect holdingRect, SkillDrawMode mode, string tooltipPrefix = "")
		{
			...
			Rect position = new Rect(rect.xMax, 0f, 19f, 19f);
