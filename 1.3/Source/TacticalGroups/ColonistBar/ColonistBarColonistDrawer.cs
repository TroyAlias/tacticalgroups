...
namespace TacticalGroups
{
    ...
    public class ColonistBarColonistDrawer
    {
        ...
        public void DrawColonist(Rect rect, Pawn colonist, Map pawnMap, bool highlight, bool reordering)
        {
            ...
            Rect pawnIconRect = GetPawnTextureRect(rect.position);
            Vector2 pawnTextureSize = PawnTextureSize * TacticalGroupsSettings.PawnScale;
        ...
        public void DrawIcons(Rect rect, Pawn colonist)
        {
            ...
            float num = Mathf.Min(BaseIconAreaWidth / tmpIconsToDraw.Count, BaseIconMaxSize) * TacticUtils.TacticalColonistBar.Scale;
        ...
        public void DrawSelectionOverlayOnGUI(Pawn colonist, Rect rect)
        {
            ...
            SelectionDrawerUtility.CalculateSelectionBracketPositionsUI<object>(textureSize: new Vector2(SelectionDrawerUtility.SelectedTexGUI.width * num, SelectionDrawerUtility.SelectedTexGUI.height * num), bracketLocs: bracketLocs, obj: obj, rect: rect, selectTimes: SelectionDrawer.SelectTimes, jumpDistanceFactor: 20f * TacticUtils.TacticalColonistBar.Scale);
        ...
        {
            float num = 0.4f * TacticUtils.TacticalColonistBar.Scale;
            SelectionDrawerUtility.CalculateSelectionBracketPositionsUI<WorldObject>(textureSize: new Vector2(SelectionDrawerUtility.SelectedTexGUI.width * num, SelectionDrawerUtility.SelectedTexGUI.height * num), bracketLocs: bracketLocs, obj: caravan, rect: rect, selectTimes: WorldSelectionDrawer.SelectTimes, jumpDistanceFactor: 20f * TacticUtils.TacticalColonistBar.Scale);
            DrawSelectionOverlayOnGUI(bracketLocs, num);
        }
        ...
        public static void ShowDrafteesWeapon(Rect rect, Pawn colonist, int weaponPlacementYOffset)
        {
            ...
            ThingOwner container = colonist.equipment.GetDirectlyHeldThings();
            ...
            float size = rect.width * TacticalGroupsSettings.WeaponShowScale;
            float diff = size - rect.width;
            float xPos = rect.x - (diff / 2f);
