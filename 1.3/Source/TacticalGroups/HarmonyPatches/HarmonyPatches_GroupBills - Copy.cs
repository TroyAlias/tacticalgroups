...
namespace RimWorld
{
	public class Dialog_BillConfig : Window
	{
		...
		public static string CustomString(Bill bill)
        {
			return "fuckyou";
        }
		public override void DoWindowContents(Rect inRect)
		{
			...
			Widgets.DefIcon(new Rect(0f, rect.y, 34f, 34f), bill.recipe, null, 1f, null, drawPlaceholder: true);
			...
			if (!flag)
			{
				...
				ThingFilterUI.DoThingFilterConfigWindow(rect4, thingFilterState, bill.ingredientFilter, bill.recipe.fixedIngredientFilter, 4, null, bill.recipe.forceHiddenSpecialFilters, forceHideHitPointsConfig: false, bill.recipe.GetPremultipliedSmallIngredients(), bill.Map);
